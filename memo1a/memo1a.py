...
def _(mo):
    ...
    ## Changelog
    - updated visualiser from A01v01 document
    - updated assumptions to suit the new facility (the facility is now not acyclic, but each wing is)

    ## Defintions
    - **The ESRC**: the Emberlight Subterranean Research Complex
    - **Facility**: the entire facility (all wings)
    ...
    - **Wing**: sub-**facilities** connected with inter-wing coridoors
    ...
    - Each wing is an acyclic subgraph of the facility
